      ...
      return (
        ...
        <div>
          <TextField
            label="Add New Item"
            variant="outlined"
            onChange={this.handleChange} //onChange={call handleChange here}
            value={this.state.content} //value={set the content state here}
          
        />
        <Button
          style={{ marginLeft: "10px" }}
          onClick={this.handleSubmit} //onClick={call handleSubmit here}
          variant="contained"
          color="primary"
        >
          Add
